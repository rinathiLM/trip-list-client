...
var tripEvents = __webpack_require__(16);
...
var onCreateTrip = function onCreateTrip(event) {
  ...
  api.createTrip(data).then(ui.createTripSuccess).catch(ui.createTripFailure);
};

var onShowAllTrips = function onShowAllTrips(event) {
  event.preventDefault();
  api.getTrips().then(ui.getTripsSuccess)
  // have to enable this since update/delete is in handlebars
  .then(function () {
    return $('.update-trip').on('click', onUpdateTrip);
  }).then(function () {
    return $('.undo-update').on('click', onUndoUpdate);
  }).then(function () {
    return $('.delete-trip').on('click', onDeleteTrip);
...
var onDeleteTrip = function onDeleteTrip(event) {
  ...
  api.deleteTrip(tripId).then(ui.deleteTripSuccess(tripId)).then(getTripsAgain).catch(ui.deleteTripFailure);
};
...
var onUpdateTrip = function onUpdateTrip(event) {
  ...
  api.updateTrip(tripId).then(ui.updateTripSuccess(tripId)).then(getTripsAgain).catch(ui.updateTripFailure);
};

var onUndoUpdate = function onUndoUpdate(event) {
  event.preventDefault();
  // console.log('not yet is clicked in update modal')
  var tripId = $(event.target).data('id');
  // console.log('trip to edit id is ', tripId)
  api.updateTripFalse(tripId).then(ui.updateTripFalseSuccess(tripId)).then(getTripsAgain).catch(ui.updateTripFalseFailure);
};

var getTripsAgain = function getTripsAgain(event) {
  api.getTrips().then(ui.getTripsSuccess)
  // have to enable this since update/delete is in handlebars
  .then(function () {
    return $('.update-trip').on('click', onUpdateTrip);
...
var clearUpdateMessage = function clearUpdateMessage() {
  $('#clearUpdate').text('');
};

var clearDeleteMessage = function clearDeleteMessage() {
  $('#clearDelete').text('');
};
...
var updateTrip = function updateTrip(tripId) {
  return $.ajax({
    url: config.apiOrigin + '/trips/' + tripId,
    method: 'PATCH',
    headers: {
...
var updateTripFalse = function updateTripFalse(tripId) {
  return $.ajax({
    url: config.apiOrigin + '/trips/' + tripId,
    method: 'PATCH',
    headers: {
...
module.exports = {
  ...
  updateTripFalse: updateTripFalse
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showTripsTemplate = __webpack_require__(19);
...
var getTripsSuccess = function getTripsSuccess(data) {
  ...
  var showTripsHtml = showTripsTemplate({ trips: data.trips });
...
var deleteTripSuccess = function deleteTripSuccess(tripId) {
...
var updateTripFalseSuccess = function updateTripFalseSuccess(data) {
  //  console.log('updated trip successfully, data returned is ', data)
  $('.modal-backdrop').remove();
};

var updateTripFalseFailure = function updateTripFalseFailure() {
  // console.log('Error updating trip')
  $('#update-message').text('Error udpating this entry, please try again.');
};
...
module.exports = {
  ...
  updateTripFalseSuccess: updateTripFalseSuccess,
  updateTripFalseFailure: updateTripFalseFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.trips : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <div class=\"grid col-sm-6 col-md-4\">\n      <h3>"
    ...
    + "\" onerror=this.src=\"https://i.imgur.com/BRA2mQf.png\">\n        <div class=\"clearfix\"></div>\n        <div class=\"caption\">\n          <h4>Ready to check this place off your list? "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.done : stack1), depth0))
    + "</h4>\n          <button class=\"btn btn-default\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#update-trip-modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><span class=\"glyphicon glyphicon-pencil\"></span>\n        </button>\n          <button class=\"btn btn-default\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#delete-trip-modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><span class=\"glyphicon glyphicon-trash\"></span>\n        </button>\n        </div>\n      </div>\n    </div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "  <h3>It doesn't look like you have any trips.</h3>\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "  <!-- update trip modal -->\n  <div class=\"modal fade\" id=\"update-trip-modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"updateModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <span id=\"update-message\"></span>\n        </div>\n        <div class=\"modal-body\">\n          <p>Did you visit this place?</p>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"update-trip btn btn-success\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Yes!</button>\n          <button type=\"button\" class=\"undo-update btn btn-default\" id=\"clearUpdate\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-dismiss=\"modal\">Not yet</button>\n        </div>\n      </div>\n    </div>\n  </div>\n  </div>\n\n  <!-- delete trip modal with warning -->\n  <div class=\"modal fade\" id=\"delete-trip-modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"deleteModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <span id=\"delete-message\"></span>\n        </div>\n        <div class=\"modal-body\">\n          <p>Are you sure you want to delete this trip?</p>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"delete-trip btn btn-danger\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n          <button type=\"button\" class=\"btn btn-default\" id=\"clearDelete\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.trips : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</table>\n\n<!-- MODALS -->\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.trips : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
